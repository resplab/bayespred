...
`project_pm()` regresses the posterior-mean soft labels onto a design matrix,
producing a standalone `bpm_proj_pm` object — a simplified deployable model
...
The `bpm_proj_pm` object is fully self-contained and requires only base R at
deployment time.
